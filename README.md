...
Stack
Python, Flask, Cohere Embed v3, Cohere Command R7B, NumPy, vanilla JS/HTML/CSS
Usage
Enter a ticker, paste headlines (one per line), add your Cohere API key, and hit Run. API key is never stored or sent anywhere except directly to Cohere.
